...
export default function App() {
  ...
  useEffect(() => {
        ...
        if (readySetups.length > 0) {
                ...
                console.log("🔥 READY setups detected:", tickers);
                if ("Notification" in window && Notification.permission === "granted") {
                          new Notification("🔥 READY Setup Detected", {
                                      body: `Scanner found READY setups in: ${tickers}`,
                          });
                }
        }
  }, [rows]);
  ...
  async function runScan() {
        ...
        try {
                const response = await fetch(
                          `/.netlify/functions/scan?symbols=${encodeURIComponent(symbolsInput)}`
                        );
  ...
  const filtered = useMemo(() => {
        ...
        list.sort((a, b) => {
                if (sortBy === "signal") {
                          return (entrySignalOrder[a.entrySignal] ?? 2) - (entrySignalOrder[b.entrySignal] ?? 2);
                }
                if (sortBy === "timing") {
                          return timingOrder[a.timingState] - timingOrder[b.timingState];
                }
  ...
  const selectedRow =
        filtered.find((r) => r.ticker === selectedTicker) ||
        rows.find((r) => r.ticker === selectedTicker);
              ...
              <div className="container">
                      <motion.section
                                ...
                                <div className="card hero-card">
                                            <div className="label">
                                                          <Radar size={15} /> Part 2 Precision Layer
                                            </div>div>
                                            <h1>PDH / PDL + EST session + displacement</h1>h1>
                                            <p>
                                                          This version upgrades the decision engine with previous-day liquidity context, EST
                                                          session labels, displacement strength, and tighter timing logic built around how you
                                                          actually trade.
                                            </p>p>
                                            <div className="hero-stats">
                                                          <div className="mini-stat">
                                                                          <span>Qualified Setups</span>span>
                                                                          <strong>{rows.length}</strong>strong>
                                                          </div>div>
                                                          <div className="mini-stat">
                                                                          <span>Best Contracts</span>span>
                                                                          <strong>{bestContracts.length}</strong>strong>
                                                          </div>div>
                                                          <div className="mini-stat">
                                                                          <span>Mode</span>span>
                                                                          <strong>EST</strong>strong>
                                                          </div>div>
                                            </div>div>
                                </div>div>
                                <div className="card side-card">
                                            <h3>
                                                          <Target size={18} /> Precision add-ons
                                            </h3>h3>
                                            <div className="note">
                                                          <strong>Liquidity context:</strong>strong> Near PDH, Near PDL, Above PDH, Below PDL, or
                                                          inside prior day range.
                                            </div>div>
                                            <div className="note">
                                                          <strong>Session:</strong>strong> EST-based labels built for your workflow, including Asia,
                                                          Pre-London, London Expansion, and Post-Move.
                                            </div>div>
                                            <div className="note">
                                                          <strong>Displacement:</strong>strong> strong, moderate, or weak based on current impulse vs
                                                          recent average range.
                                            </div>div>
                                            <div className="note">
                                                          <strong>Timing:</strong>strong> READY, WATCH, EARLY, or AVOID now factors in liquidity and
                                                          session context.
                                            </div>div>
                                </div>div>
                                ...
                                <div className="filter-grid live-grid">
                                            <div className="field live-symbols">
                                                          ...
                                                          <textarea
                                                                            ...
                                                                            placeholder="AAPL,NVDA,AMD,TSLA"
                                                                          />
                                            </div>div>
                                            <div className="field">
                                            ...
                                            <div className="field action-field">
                                                          ...
                                                          <button
                                                                          ...
                                                                          <RefreshCw
                                                                                              size={16}
                                                                                              className={scanStatus === "loading" ? "spin" : ""}
                                                                                            />
                    ...
                    <section className="dashboard-grid">
                                <div className="card overview-card">
                                              <div className="section-title">
                                                              <CandlestickChart size={18} /> Selected setup
                                              </div>div>
                                              <div className="overview-grid">
                                                              <div className="metric-box">
                                                                                <span>Ticker</span>span>
                                                                                <strong>{selectedRow.ticker}</strong>strong>
                                                              </div>div>
                                                              <div className="metric-box">
                                                                                <span>Bias</span>span>
                                                                                <strong>{selectedRow.bias}</strong>strong>
                                                              </div>div>
                                                              <div className="metric-box">
                                                                                <span>Quality</span>span>
                                                                                <strong>{selectedRow.setupQuality}</strong>strong>
                                                              </div>div>
                                                              <div className="metric-box">
                                                                                <span>Trade score</span>
                                                                                <strong>{selectedRow.finalTradeScore}</strong>strong>
                                                              </div>div>
                                              </div>div>
                                              <div className="chips">
                                                              <span className={biasClass(selectedRow.bias)}>{selectedRow.bias}</span>span>
                                                              <span className={qualityClass(selectedRow.setupQuality)}>
                                                                {selectedRow.setupQuality}
                                                              </span>span>
                                                              <span className={timingClass(selectedRow.timingState)}>
                                                                                <span className="timing-dot"></span>span>
                                                                {selectedRow.timingState}
                                                              </span>span>
                                ...
                                <div className="card intelligence-card">
                                              <div className="section-title">
                                                              <Activity size={18} /> Precision readout
                                              </div>div>
                                              <div className="intelligence-grid">
                                                              <div className="detail">
                                                                                <span>Structure</span>span>
                                                                                <strong>{selectedRow.structureScore}</strong>strong>
                                                              </div>div>
                                                              <div className="detail">
                                                                                <span>Location</span>span>
                                                                                <strong>{selectedRow.locationScore}</strong>strong>
                                                              </div>div>
                                                              <div className="detail">
                                                                                <span>Liquidity</span>span>
                                                                                <strong>{selectedRow.liquidityScore}</strong>strong>
                                                              </div>div>
                                                              <div className="detail">
                                                                                <span>Displacement</span>span>
                                                                                <strong>{selectedRow.displacementScore}</strong>strong>
                                                              </div>div>
                                                              <div className="detail">
                                                                                <span>Session</span>span>
                                                                                <strong>{selectedRow.sessionScore}</strong>strong>
                                                              </div>div>
                                                              <div className="detail">
                                                                                <span>Room</span>span>
                                                                                <strong>{selectedRow.roomScore}</strong>strong>
                                                              </div>div>
                                                              <div className="detail">
                                                                                <span>PDH</span>span>
                                                                                <strong>${selectedRow.pdh}</strong>strong>
                                                              </div>div>
                                                              <div className="detail">
                                                                                <span>PDL</span>span>
                                                                                <strong>${selectedRow.pdl}</strong>strong>
                                                              </div>div>
                                              </div>div>
                                </div>div>
                    </section>section>
                      ...
                      <section className="content-grid">
                                <motion.div
                                            ...
                                            >
                                            <div className="section-title">
                                                          <ShieldCheck size={18} /> Qualified setups
                                            </div>div>
                                            <div className="setup-list">
                                              {filtered.length === 0 ? (
                                                              <div className="empty-state">
                                                                                <h3>No qualified setups yet</h3>h3>
                                                                                <p>Run the scan to populate the precision shortlist.</p>p>
                                                              </div>div>
                                                            ) : (
                                                              filtered.map((stock) => (
                                                                                  <button
                                                                                                        key={stock.ticker}
                                                                                                        className={`setup-card selectable-card ${
                                                                                                                                selectedTicker === stock.ticker ? "selected-card" : ""
                                                                                                          }`}
                                                                                                        onClick={() => {
                                                                                                      ...
                                                                                                      <div className="setup-top">
                                                                                                                            <div>
                                                                                                                                                    <div className="ticker-row">
                                                                                                                                                                              ...
                                                                                                                                                                              <span className={qualityClass(stock.setupQuality)}>
                                                                                                                                                                                                          {stock.setupQuality}
                                                                                                                                                                                                        </span>span>
                                                                                                                                                                              <span className={timingClass(stock.timingState)}>
                                                                                                                                                                                                          <span className="timing-dot"></span>span>
                                                                                                                                                                                                          {stock.timingState}
                                                                                                                                                                                                        </span>span>
                                                                                                                                                                              <span className="pill">{stock.liquidityContext}</span>span>
                                                                                                                                                                              <span className="pill">{stock.sessionLabel}</span>span>
                                                                                                                                                                              <div className={`entry-signal ${stock.entrySignal}`}>
                                                                                                                                                                                                          {stock.entrySignal === "READY" && "🔥 READY"}
                                                                                                                                                                                                          {stock.entrySignal === "WATCH" && "🟡 WATCH"}
                                                                                                                                                                                                          {stock.entrySignal === "NO_TRADE" && "🔴 NO TRADE"}
                                                                                                                                                                                                        </div>div>
                                                                                                                                                      </div>div>
                                                                                                                                                    <p className="meta">{stock.reason}</p>p>
                                                                                                                              </div>div>
                                                                                                                            <div className="score-grid">
                                                                                                                                                    <div className={scoreClass(stock.bestScore)}>
                                                                                                                                                                              <span>Setup</span>span>
                                                                                                                                                                              <strong>{stock.bestScore}</strong>strong>
                                                                                                                                                      </div>div>
                                                                                                                                                    <div className={scoreClass(stock.finalTradeScore)}>
                                                                                                                                                                              <span>Trade</span>span>
                                                                                                                                                                              <strong>{stock.finalTradeScore}</strong>strong>
                                                                                                                                                      </div>div>
                                                                                                                                                    <div className={scoreClass(stock.liquidityScore)}>
                                                                                                                                                                              <span>Liquidity</span>span>
                                                                                                                                                                              <strong>{stock.liquidityScore}</strong>strong>
                                                                                                                                                      </div>div>
                                                                                                                                                    <div className={scoreClass(stock.displacementScore)}>
                                                                                                                                                                              <span>Displacement</span>span>
                                                                                                                                                                              <strong>{stock.displacementScore}</strong>strong>
                                                                                                                                                      </div>div>
                                                                                                                              </div>div>
                                                                                                        </div>div>
                                                                                                      <button
                                ...
                                <div className="right-rail">
                                            <motion.div
                                                          ...
                                                          >
                                                          <div className="section-title">
                                                                          <Target size={18} /> Best contracts today
                                                          </div>div>
                                                          <div className="rail-list">
                                                            {bestContracts.length === 0 ? (
                                                                              <div className="note">
                                                                                                  Select a setup and load contracts to see the top picks.
                                                                              </div>div>
                                                                            ) : (
                                                                              bestContracts.map((c, idx) => (
                                                                                                    <div key={c.symbol} className="rail-item rail-item-column">
                                                                                                                          <div>
                                                                                                                                                  ...
                                                                                                                                                  <span>
                                                                                                                                                    {c.expiration} · Strike {fmt(c.strike)}
                                                                                                                                                    </span>span>
                                                                                                                            </div>div>
                                                                                                                          <div className="mini-metrics">
                                                                                                                                                  <span>Score {c.contractScore}</span>span>
                                                                                                                                                  <span>Δ {fmt(c.delta, 3)}</span>span>
                                                                                                                                                  <span>Spread {fmt(c.spreadPct)}%</span>span>
                                                                                                                            </div>div>
                                                                                                      </div>div>
                                                                                                  ))
                                                                            )}
                                            ...
                                            <motion.div
                                                          ...
                                                          >
                                                          <div className="section-title">
                                                                          <Clock3 size={18} /> Contract filter
                                                          </div>div>
                                                          <div className="contract-toolbar compact-toolbar">
                                                                          ...
                                                                          <div className="field">
                                                                                            ...
                                                                                            <select
                                                                                                                  value={contractSide}
                                                                                                                  onChange={(e) => setContractSide(e.target.value)}
                                                                                                                >
                                                                                                                <option value="calls">Calls</option>option>
                                                                                                                <option value="puts">Puts</option>option>
                                                                                              </select>select>
                                                                          ...
                                                                          <div className="field">
                                                                                            <label>Max spread %</label>label>
                                                                                            <input
                                                                                                                  type="number"
                                                                                                                  step="0.5"
                                                                                                                  value={maxSpreadPct}
                                                                                                                  onChange={(e) => setMaxSpreadPct(Number(e.target.value || 0))}
                                                                                                                />
                                                                          </div>div>
                                                                          <div className="field">
                                                                                            <label>Min |delta|</label>label>
                                                                                            <input
                                                                                                                  type="number"
                                                                                                                  step="0.05"
                                                                                                                  value={minDeltaAbs}
                                                                                                                  onChange={(e) => setMinDeltaAbs(Number(e.target.value || 0))}
                                                                                                                />
                                                                          </div>div>
                                                                          <div className="field">
                                                                                            <label>Max |delta|</label>label>
                                                                                            <input
                                                                                                                  type="number"
                                                                                                                  step="0.05"
                                                                                                                  value={maxDeltaAbs}
                                                                                                                  onChange={(e) => setMaxDeltaAbs(Number(e.target.value || 0))}
                                                                                                                />
                                                                          </div>div>
                                                                          <div className="field">
                                                                                            <label>Nearest exps</label>label>
                                                                                            <input
                                                                                                                  type="number"
                                                                                                                  min="1"
                                                                                                                  max="6"
                                                                                                                  value={maxExpirations}
                                                                                                                  onChange={(e) => setMaxExpirations(Number(e.target.value || 1))}
                                                                                                                />
                                                                          </div>div>
                                                                          <div className="field action-field">
                                                                                            ...
                                                                                            <button
                                                                                                                ...
                                                                                                                <RefreshCw
                                                                                                                                        size={16}
                                                                                                                                        className={contractStatus === "loading" ? "spin" : ""}
                                                                                                                                      />
                                              ...
                                              {contractMeta && (
                                                                            <div className="chips padded">
                                                                                              ...
                                                                                              <span className="pill">
                                                                                                                  Underlying ${fmt(contractMeta.underlyingPrice)}
                                                                                                </span>span>
                                                                              {contractMeta.expirationsUsed.map((exp) => (
                                                                                                  <span key={exp} className="pill">
                                                                                                    {exp}
                                                                                                    </span>span>
                                                                                                ))}
                                                                            </div>div>
                      ...
                      <section className="card contract-panel">
                                <div className="section-title">
                                            <Shapes size={18} /> Contract table
                                </div>div>
                        {contracts.length === 0 ? (
                      <div className="empty-state contract-empty">
                                    <h3>No contracts loaded</h3>h3>
                                    <p>Pick a setup and load contracts to see ranked options.</p>p>
                      </div>div>
                    ) : (
                      <div className="table-wrap">
                                    <table className="contract-table">
                                            ...
                                            <tr key={item.symbol}>
                                                                  <td>{idx + 1}</td>td>
                                                                  <td className="mono">{item.symbol}</td>td>
                                                                  <td>{item.expiration}</td>td>
                                                                  <td>{fmt(item.strike)}</td>td>
                                                                  <td>{fmt(item.bid)}</td>td>
                                                                  <td>{fmt(item.ask)}</td>td>
                                                                  <td>{fmt(item.spreadPct)}</td>td>
                                                                  <td>{item.volume}</td>td>
                                                                  <td>{item.openInterest}</td>td>
                                                                  <td>{fmt(item.delta, 3)}</td>td>
                                                                  <td>{fmt(item.iv, 3)}</td>td>
                                                                  <td>
                                                                                          <span className={scoreClass(item.contractScore)}>
                                                                                            {item.contractScore}
                                                                                            </span>span>
                                                                  </td>td>
                                            </tr>tr>
                      ...
                      <section className="card contract-panel">
                                ...
                                <div className="journal-stats">
                                            <div className="mini-stat">
                                                          ...
                                                          <strong>{journal.length}</strong>strong>
                                            </div>div>
                                            <div className="mini-stat">
                                                          <span>Trades Taken</span>span>
                                                          <strong>{journal.filter((j) => j.tradeTaken === "Yes").length}</strong>strong>
                                            </div>div>
                                            <div className="mini-stat">
                                                          <span>Wins</span>span>
                                                          <strong>{journal.filter((j) => j.outcome === "Win").length}</strong>strong>
                                            </div>div>
                                            <div className="mini-stat">
                                                          <span>READY Signals</span>span>
                                                          <strong>{journal.filter((j) => j.entrySignal === "READY").length}</strong>strong>
                                            </div>div>
                                </div>div>
                        {journal.length === 0 ? (
                      <div className="empty-state contract-empty">
                                    <h3>No journal entries yet</h3>h3>
                                    <p>Save setups from the scanner to start tracking what works.</p>p>
                      </div>div>
                    ) : (
                      <div className="table-wrap">
                                    <table className="contract-table">
                                                    <thead>
                                                                      <tr>
                                                                                          ...
                                                                                          <th>Quality</th>th>
                                                                                          <th>Signal</th>th>
                                                                                          <th>Trade Score</th>th>
                                                                                          <th>Trade Taken</th>th>
                                                                                          <th>Outcome</th>th>
                                                                                          <th>Notes</th>th>
                                                                                          <th>Delete</th>th>
                                                                      </tr>tr>
