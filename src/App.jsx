...
export default function App() {
  ...
  function updateJournalEntry(id, field, value) {
          setJournal((prev) =>
                    prev.map((item) => (item.id === id ? Object.assign({}, item, { [field]: value }) : item))
                         );
  }
  ...
  const filtered = useMemo(() => {
          ...
          list.sort((a, b) => {
                    if (sortBy === "signal") {
                                return (entrySignalOrder[a.entrySignal] != null ? entrySignalOrder[a.entrySignal] : 2) -
                                                   (entrySignalOrder[b.entrySignal] != null ? entrySignalOrder[b.entrySignal] : 2);
                    }
                ...
                <div className="container">
                        <motion.section
                                  ...
                                  <div className="card side-card">
                                              ...
                                              <div className="note">
                                                            <strong>Liquidity context:</strong>strong> Near PDH, Near PDL, Above PDH, Below PDL, or inside prior day range.
                                              </div>div>
                                              <div className="note">
                                                            <strong>Session:</strong>strong> EST-based labels built for your workflow, including Asia, Pre-London, London Expansion, and Post-Move.
                                              </div>div>
                                              <div className="note">
                                                            <strong>Displacement:</strong>strong> strong, moderate, or weak based on current impulse vs recent average range.
                                              </div>div>
                                              <div className="note">
                                                            <strong>Timing:</strong>strong> READY, WATCH, EARLY, or AVOID now factors in liquidity and session context.
                                              </div>div>
                                  </div>div>
                        ...
                        <section className="card filter-card">
                            ...
                            {lastUpdated && (
                          <div className="subtle">Last updated: {new Date(lastUpdated).toLocaleString()}</div>div>
                                  )}
                            {scanStatus === "error" && (
                                                                    ...
                                                                    filtered.map((stock) => (
                                                                                          <button
                                                                                                              ...
                                                                                                              <button
                                                                                                                                        ...
                                                                                                                                        onClick={(e) => { e.stopPropagation(); saveToJournal(stock); }}
                                                                                                                                      >
                                                                                                                                    Save to Journal
                                                                                                                  </button>button>
                                                                                              </button>button>
                                                                ...
                                                                {bestContracts.length === 0 ? (
                                                                                    ...
                                                                                    bestContracts.map((c, idx) => (
                                                                                                            <div key={c.symbol} className="rail-item rail-item-column">
                                                                                                                                  <div>
                                                                                                                                                          <strong>#{idx + 1} {c.symbol}</strong>strong>
                                                                                                                                                          <span>{c.expiration} · Strike {fmt(c.strike)}</span>span>
                                                                                                                                      </div>div>
                                                            ...
                                                            <div className="contract-toolbar compact-toolbar">
                                                                            <div className="field">
                                                                                              ...
                                                                                              <select value={selectedTicker} onChange={(e) => setSelectedTicker(e.target.value)}>
                                                                                                  ...
                                                                                                  {rows.map((row) => (
                                                                                        <option key={row.ticker} value={row.ticker}>{row.ticker}</option>option>
                                                                                      ))}
                                                                                                  </select>select>
                                                                            </div>div>
                                                                            <div className="field">
                        ...
                        <section className="card contract-panel">
                          ...
                          <div className="table-wrap">
                                        <table className="contract-table">
                                                        <thead>
                                                                          <tr>
                                                                                              <th>Rank</th>th><th>Symbol</th>th><th>Exp</th>th><th>Strike</th>th>
                                                                                              <th>Bid</th>th><th>Ask</th>th><th>Spread %</th>th><th>Volume</th>th>
                                                                                              <th>Open Int</th>th><th>Delta</th>th><th>IV</th>th><th>Score</th>th>
                                                                          </tr>tr>
                                                        </thead>thead>
                                                        <tbody>
                        ...
                        <section className="card contract-panel">
                          ...
                          <div className="table-wrap">
                                        <table className="contract-table">
                                                        <thead>
                                                                          <tr>
                                                                                              <th>Date</th>th><th>Ticker</th>th><th>Bias</th>th><th>Quality</th>th>
                                                                                              <th>Signal</th>th><th>Trade Score</th>th><th>Trade Taken</th>th>
                                                                                              <th>Outcome</th>th><th>Notes</th>th><th>Delete</th>th>
                                                                          </tr>tr>
                                                        </thead>thead>
                                                        <tbody>
                                                            {journal.map((entry) => (
                                                  <tr key={entry.id}>
                                                                        ...
                                                                        <td>
                                                                                                <button className="delete-button" onClick={() => deleteJournalEntry(entry.id)}>X</button>button>
                                                                        </td>td>
                                                  </tr>tr>
                                                ))}
                                                        </tbody>tbody>
